...
const DocumentWriterForm = ({ accessToken, serviceType }: PageProps) => {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-4/12 shadow-lg rounded-lg bg-white p-7">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Info about your Document</FormLabel>
                            <FormControl>
                                <Textarea
                                    placeholder="Tell us a little bit about your document"
                                    className="resize-y"
                                    {...field}
                                />
                            </FormControl>
...
export default DocumentWriterForm