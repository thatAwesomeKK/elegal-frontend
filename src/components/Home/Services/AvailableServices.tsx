import { fetchAvailableServiceRequest, fetchMatchServiceRequest } from '@/lib/apiCalls/service';
...
const AvailableServices = async () => {
    ...
    return (
        <section className='my-10 mx-20'>
            <h1 className={`${permanentMarker.className} text-gray-600 text-8xl font-bold text-center mb-16 underline`}>Available Services</h1>
